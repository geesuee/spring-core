...
public class ApplicationContextExtendsFindTest {
    ...
    void findBeanByParentTypeDuplicate() {
        // NoUniqueBeanDefinitionException: No qualifying bean of type 'hello.springcore.discount.DiscountPolicy'
        // available: expected single matching bean but found 2: rateDiscoutPolicy,fixDiscountPolicy
